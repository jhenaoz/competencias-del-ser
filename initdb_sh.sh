...
{"index":{"_id": "1"}}
{"id":1, "es": "Apertura","en": "Openness", "behaviors": [{"id": "1", "es": "Acepta sugerencias sin distincion de quien las de", "en": "They accept suggestions regardless of who gives them"}, {"id": "2", "es": "Reconoce sus errores", "en": "They recognize their mistakes"}, {"id": "3", "es": "Solicita sugerencias", "en": "They ask for suggestions"}, {"id": "4", "es": "Se evidencian sus acciones de mejora", "en": "Their actions towards improvement are apparent"}, {"id": "5", "es": "Informa oportunamente situaciones que representan riesgos u obstaculos para el equipo", "en": "They opportunely inform of situations that represent risks and obstacles for the team"}]}
{"index":{"_id": "2"}}
{"id":2, "es": "Comunicacion","en": "Communication", "behaviors": [{"id": "1", "es": "Comunica sus ideas de manera clara, garantizando que las otras personas entiendan el mensaje", "en": "They communicate their ideas clearly, ensuring that other people understand the message"}, {"id": "2", "es": "Al transmitir sus ideas lo hace en buenos terminos y con un tono de voz adecuado", "en": "When transmitting their ideas they do it in good terms and with an appropriate voice tone"}, {"id": "3", "es": "Escucha a los demas permitiendo que expresen de forma completa sus ideas y acepta como validas opiniones diferentes", "en": "They listen to those around, allowing people to express their ideas in a complete manner, and accept different opinions as valid"}, {"id": "4", "es": "Basa su comunicacion en ejemplos y situaciones evitando suponer", "en": "They base their communication on examples and situations, avoiding making assumptions"}, {"id": "5", "es": "Antes de entablar la comunicacion entiende como se siente o esta la otra persona, para saber si es el momento adecuado", "en": "Before establishing communication they try to understand how the other feels, seeking to ensure that the moment is appropriate"}]}
{"index":{"_id": "3"}}
{"id":3, "es": "Iniciativa","en": "Initiative", "behaviors": [{"id": "1", "es": "Busca y propone alternativas para solucionar alguna situacion determinada (opciones de mejora, obstaculos) sin esperar que alguien se lo diga", "en": "They search and propose alternatives to solve particular situations (improvement options, obstacles) without someone telling them to do so"}, {"id": "2", "es": "Propone alternativas que tienen en cuenta la relacion costo / beneficio (analizando que tan costoso es algo frente al beneficio obtenido)", "en": "They propose alternatives that consider the cost-benefit (analyzing the cost compared with the benefit received)"}, {"id": "3", "es": "Las acciones propuestas estan alineadas con la situacion que se requiere solucionar", "en": "Their suggested actions are aligned with the situation and the solution sought"}, {"id": "4", "es": "Define acciones concretas para llevar a cabo la implementacion de las propuestas realizadas", "en": "They define concrete actions to execute the implementation of the proposals"}]}
{"index":{"_id": "4"}}
{"id":4, "es": "Orientacion al cliente","en": "Client orientation", "behaviors": [{"id": "1", "es": "Identifica las necesidades de los clientes", "en": "They identify the client needs correctly"}, {"id": "2", "es": "Muestra preocupacion y sensibilidad por solucionar los problemas del cliente", "en": "They show concern and sensitivity towards solving the client\u0027s problems"}, {"id": "3", "es": "Define acciones concretas que permiten solucionar las necesidades o problemas del cliente", "en": "They define concrete actions that allow to solve the client\u0027s problems and needs"}, {"id": "4", "es": "Propone soluciones que sorprenden al cliente entregando mas de lo que esperaba", "en": "They propose solutions that surprise the client, delivering more than expected"}, {"id": "5", "es": "Genera relaciones con el cliente basadas en la confianza, cumpliendo los compromisos definidos y diciendo siempre la verdad", "en": "They create connections with the client based on trust, fulfilling the defined agreement and always telling the truth"}]}
{"index":{"_id": "5"}}
{"id":5, "es": "Logros y resultados","en": "Achievements and results", "behaviors": [{"id": "1", "es": "Cumple con los compromisos adquiridos", "en": "They fulfill their commitments"}, {"id": "2", "es": "Identifica y consigue los elementos requeridos para el cumplimiento de los compromisos", "en": "They identify and obtain the required elements for the fulfillment of their commitments"}, {"id": "3", "es": "Constantemente esta en busqueda de nuevos retos y aprendizajes", "en": "They are constantly searching for new challenges and learning opportunities"}, {"id": "4", "es": "Se anticipa a posibles obstaculos y define acciones de mitigacion necesarias", "en": "They anticipate possible obstacles and define necessary mitigation actions"}]}
{"index":{"_id": "6"}}
