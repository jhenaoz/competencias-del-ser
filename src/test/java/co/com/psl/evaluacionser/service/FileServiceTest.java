...
public class FileServiceTest {
    ...
    public void getFileNameWithBothDates() throws Exception {
        StringBuilder fileName = fileService.getFileName("Josias Montoya", "1993-07-05", "2017-03-14");

        assertEquals("Valoración Competencias Ser Josias Montoya del 1993-07-05 al 2017-03-14.xlsx",fileName.toString());
    }
    ...
    public void getFileNameWithOneDates() throws Exception {
        StringBuilder fileName = fileService.getFileName("Josias Montoya", null, "2017-03-14");
